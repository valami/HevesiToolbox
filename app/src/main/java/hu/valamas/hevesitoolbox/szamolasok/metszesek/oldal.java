...
public class oldal extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_oldal);
        ...
        final EditText gamma_e = (EditText) findViewById(R.id.gamma_in);
        ...
        //Szögbevitel gamma
        gamma_e.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                String szog_bent =gamma_e.getText().toString();
                String szog_tagolt = szogkezeles.tagolas(szog_bent)[0];
                if (!szog_bent.equals(szog_tagolt)) {
                    gamma_e.setText(szog_tagolt);
                    gamma_e.setSelection(gamma_e.getText().length());
                }
                if (szogkezeles.tagolas(szog_bent)[1].equals("1"))  {
                    gamma_e.setFilters(new InputFilter[] {new InputFilter.LengthFilter(7)});
                    gamma_e.setKeyListener(DigitsKeyListener.getInstance("0123456789"));
                }   else if (szogkezeles.tagolas(szog_bent)[1].equals("2"))  {
                    gamma_e.setFilters(new InputFilter[] {new InputFilter.LengthFilter(8)});
                    gamma_e.setKeyListener(DigitsKeyListener.getInstance("0123456789"));
                }   else if (szogkezeles.tagolas(szog_bent)[1].equals("3"))  {
                    gamma_e.setFilters(new InputFilter[] {new InputFilter.LengthFilter(9)});
                    gamma_e.setKeyListener(DigitsKeyListener.getInstance("0123456789"));
                } else {
                    gamma_e.setFilters(new InputFilter[] {new InputFilter.LengthFilter(9)});
                    gamma_e.setKeyListener(DigitsKeyListener.getInstance("0123456789-."));
        ...
        szamol.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AY_e.equals("") || AX_e.equals("") || BY_e.equals("")|| BX_e.equals("") || dAP_e.equals("")|| gamma_e.equals(""))
                {
                ...
                double dAP = Double.parseDouble(szogkezeles.tagolas(dAP_bent)[2]) ;
                String gamma_bent =gamma_e.getText().toString();
                double gamma = Double.parseDouble(szogkezeles.tagolas(gamma_bent)[2]) ;
                ...
                double alfa = dAB - dAP;
                double beta = trigonometria.pi() - (alfa + gamma) ;
                double dBP = dBA + beta;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_oldal, menu);
        return true;
    }
